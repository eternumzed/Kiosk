  ...
  return (
    <div className="w-full flex flex-col items-center justify-center p-4">
      <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-xl border border-gray-100">
        <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Payment</h2>
        
        <div className="p-6 bg-gray-50 rounded-xl mb-8 border border-gray-200">
          <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Fee Breakdown</p>
          <p className="text-lg text-gray-700">Document: <span className="font-semibold">{formData.document}</span></p>
          <p className="text-2xl font-bold text-emerald-700 mt-2">Total: ₱{getFee().toFixed(2)}</p>
        </div>
        ...
        {paymentStatus === "Processing" && (
          <div className="mb-8 p-6 bg-emerald-50 rounded-xl border border-emerald-200">
            ...
            <p className="text-lg font-semibold text-emerald-700 text-center">Processing your request...</p>
